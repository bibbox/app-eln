 ...
 *
 * IARC L.Alteyrac: Customization for IARC ELN
 *		- Title: URL removed
 *		- @ %s removed from the_time
 *		- Footer: "Article printed from" removed
 *		- Footer: "URL to article" removed
 *
*/
	...
	<?php if (have_posts()): ?>
		...
		<header class="entry-header">
			...
			<span class="entry-date">
				...
				<time>
					<?php the_time(sprintf(__('%s', 'wp-print'), 
